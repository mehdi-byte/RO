...
"""
function build_tree(x::Matrix{Float64}, y::Vector{Any}, D::Int64, classes; multivariate::Bool=false, time_limit::Int64 = -1, mu::Float64=10^(-4), inegalite::Bool=false)
...
function build_tree_cluster(clusters::Vector{Cluster}, D::Int64, inegalite::Bool,classes;multivariate::Bool=false, time_limit::Int64 = -1, mu::Float64=10^(-4))
    """
